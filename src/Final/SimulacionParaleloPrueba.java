 ...
 * @author dario
 */
public class SimulacionParaleloPrueba {
    ...
    public SimulacionParaleloPrueba(int MX){
        this.MX=MX;
        this.NA=0;
        this.C1=0;
        this.C2=0;
    ...
    public void simular(){
        ...
        //importante ES: posicion 0: Cantidad de ingresos
        //               posicion 1: 
        
        do{
            //**************//CASO 1 //Pregunta si AT es el minimo entre AT, DT1 y DT2******************************
            if(AT==Math.min(AT, DT1) && AT==Math.min(AT, DT2)){ //AT<DT1 && AT<DT2
                ...
                if(ES.get(0)==0 && ES.get(1)==0 && ES.get(2)==0){ //los 2 servidores libres
                    ES.set(0, 1);
                    ES.set(1, NA); //se refiere a que el servidor 1 esta atendiente al cliente NA
                    ES.set(2, 0);
                    
                    DT1=TM+this.generarTS();  
                }
                
                else if(ES.get(0)==1 && ES.get(1)!=0 && ES.get(2)==0){ //servidor 1 ocupado, servidor 2 libre
                ...
                else if(ES.get(0)==1 && ES.get(1)==0 && ES.get(2)!=0){ //servidor 1 libre, servidor 2 ocupado
  ...
  //**************************************CASO 2************************************************************
            ...
            else if(DT1<AT && DT1<=DT2){  //SALIDA POR EL DT1 
  ...
  //************************************ CASO 3. OJO NO ESTA EN EL LIBRO*********************************************         
            else if(DT2<AT && DT2<DT1){  //SALIDA POR EL DT2 
    ...
    public static void main(String[] args) {
        ...
        SimulacionParaleloPrueba sim=new SimulacionParaleloPrueba(100);
        sim.simular();
