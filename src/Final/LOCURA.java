...
public class LOCURA {
    ...
    public LOCURA(int MX, int cantEnlaces, int cantTelefonos){
        this.AT=0;
        this.DT=9999;
        this.SS=0;
        this.WL=0;
    ...
    public void simular(){
        do{
            ...
            if(eventos.get(0).tipoEvento==1 && eventos.get(0).tiempo<=MX){ 
                ...
                //clientes.get(NA-1).clientesEnCola=NA-ND-cantEnlaces; 
            ...
            //*********************************CASO 3*********************************
                  ...
                  if(eventos.get(0).tipoEvento==1){
                      eventos.remove(0);
//                      float tiempoSalida=9999;
