...
public class Ejercicio1 {
    ...
    public Ejercicio1(int MX, int cantEnlaces, int cantTelefonos){
        this.AT=0;
        this.DT=9999;
        this.WL=0;
        this.MX=MX; 
    ...
    //System.out.println("Proporcion de exitosas: "+proporcion+"\n");
    System.out.println("Proporcion de exitosas: "+Math.rint(proporcion*1000)/1000+"\n");
...
//        conviente previamente pasarlos a segundos, operar y luego volver a convertirlos a minutos
    ...
    public static void main(String[] args) {
        ...
        Ejercicio1 sim=new Ejercicio1(200, cantEnlaces, cantTelefonos);
        sim.simular();
